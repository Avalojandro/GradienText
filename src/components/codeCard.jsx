...
export default function CodeCard({ indx = 0, code = "", className = "" }) {
  ...
  return (
    <div className="text-center flex my-12">
      <div className="bg-[#2B2B2B] mx-8 sm:mx-0 text-white w-full sm:max-w-64 py-20 px-12 rounded-tr-2xl rounded-br-2xl sm:rounded-tr-none sm:rounded-br-none rounded-tl-2xl rounded-bl-2xl flex justify-center items-center relative">
